...
/**
 * Created by Alec on 10.04.2016 г..
 */
public class TheHeiganDance {
    ...
    public static void main(String[] args) {
        ...
        double averageDamage = Double.parseDouble(scan.nextLine());
        while (true) {
            String[] attackArgs = scan.nextLine().split(" ");
            ...
            if (isPlayerInDangerZone(playerPosition)) {
    ...
    private static boolean isPlayerInDangerZone(int[] playerPosition) {
