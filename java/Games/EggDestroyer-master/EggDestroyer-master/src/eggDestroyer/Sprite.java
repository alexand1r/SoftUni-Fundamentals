...
public class Sprite { // "The Sprite class is a base class for all objects on the Board. We put here all methods and variables that are in Ball, Egg and Bone objects. Like getImage() or getX() methods."

	protected int x; // declaration of the variable(note that whether they're
						// protected or public does not affect the game, but
						// lets leave them as protected
	protected int y;
	protected int width;
	...
	public Rectangle getRect1() {
		return new Rectangle(x, y, image1.getWidth(null),
				image1.getHeight(null));

	}

	public Rectangle getRect2() {
		return new Rectangle(x, y, image2.getWidth(null),
				image1.getHeight(null));
