...
import eggDestroyer.Sprite;

import javax.swing.ImageIcon;


public class CrackedEgg extends Sprite { //the Brick Class

    String crackedImg = "../images/BrokenEgg.png";

    boolean cracked; //bool that indicates whether a brick has been destroyed or not


    public CrackedEgg (int x, int y) { //decleration of a brick's x and y
      this.x = x;
      this.y = y;
      ImageIcon ii = new ImageIcon(this.getClass().getResource(crackedImg)); //creates the brick image icon
